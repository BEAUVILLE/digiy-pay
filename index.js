...
// 🔐 Config DIGIYLYFE (Realtime Database avec tes JSON)
...
// On encapsule pour ne pas polluer le global
(function initSubscriberHeader() {
  if (!db) return;

  // Profil + abonnement + chat
  ...
  // Bouton ouvrir chat (lien vers ton PRO CHAT GitHub)
  if (btnOpenChat) {
